      ...
      switch (message.action) {
        ...
        case "translateImage": {
          ...
          try {
            ...
            ScanLateAPI.translateImageStream(imageBuffer, sourceLang, profileName, ocrModel, contextJson, imageIndex, totalImages, useMultimodal, useGeminiOcr, useAutoGlossary, dialogueOnly, ocrProvider, ocrModelSlug, ocrApiKey, llmProvider, llmModel, llmApiKey, (eventObj) => {
